...
Reference full template: `D:/code/sync-ai/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/code/sync-ai/.claude/get-shit-done/templates/state.md`.
