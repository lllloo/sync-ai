...
<execution_context>
@D:/code/sync-ai/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @D:/code/sync-ai/.claude/get-shit-done/workflows/manager.md end-to-end.
