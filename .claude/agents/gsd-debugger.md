...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/code/sync-ai/.claude
                  → checks D:/code/sync-ai/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/code/sync-ai/.claude/get-shit-done
                  → writes to D:/code/sync-ai/.claude/get-shit-done/hooks/
...
@D:/code/sync-ai/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/code/sync-ai/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "D:/code/sync-ai/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "D:/code/sync-ai/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "D:/code/sync-ai/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
