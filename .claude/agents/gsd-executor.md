...
@D:/code/sync-ai/.claude/get-shit-done/references/thinking-models-execution.md
...
**See @D:/code/sync-ai/.claude/get-shit-done/references/checkpoints.md**
...
```bash
node D:/code/sync-ai/.claude/get-shit-done/bin/gsd-tools.cjs commit-to-subrepo "{type}({phase}-{plan}): {concise task description}" --files file1 file2 ...
```
...
**Use template:** @D:/code/sync-ai/.claude/get-shit-done/templates/summary.md
...
node "D:/code/sync-ai/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap update-plan-progress "${PHASE_NUMBER}"
...
```bash
node "D:/code/sync-ai/.claude/get-shit-done/bin/gsd-tools.cjs" state add-blocker "Blocker description"
```
</state_updates>
