...
Intel system is disabled. To activate:
  ...
  node D:/code/sync-ai/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node D:/code/sync-ai/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node D:/code/sync-ai/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node D:/code/sync-ai/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: D:/code/sync-ai/.claude/get-shit-done/bin/gsd-tools.cjs
